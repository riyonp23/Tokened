...
def addEvent(self):
    ...
    from login import email
    from student import updatelb, updatepoints, updateupcoming
...
class eventPage(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.saveButton = ctk.CTkButton(self.settingFrame, text="Save", width=40, height=10, fg_color="#292929",
                                        bg_color="#292929", hover_color="#212121", command=lambda: changepass(self))

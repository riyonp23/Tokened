...
# allows students to change their grade and/or school
...
class helpPage(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.docLabel = ctk.CTkLabel(self, text="https://github.com/skyy-rad/Tokened", font=("courier new", 15),
        ...
        # configures setting menu with change password entry fields

...
img = ["./assets/back.png", "./assets/forgot.png", "./assets/menu-dots.png", "./assets/portrait.png", "./assets/power.png", "./assets/tokened.ico", "./assets/tokened-main.png", "./assets/user.png", "./assets/plus.png", "./assets/points.png", "./assets/events.png"]
